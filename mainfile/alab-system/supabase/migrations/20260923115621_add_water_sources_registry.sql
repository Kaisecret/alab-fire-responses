...
values
  ...
  ('Hamtic', 'FIRE_HYDRANT', 1, 'Poblacion 3, Hamtic, Antique (in back of ARC''s Pizza Hub)', 10.7013427, 121.9817124, 'Wet Barrel'),
  ('Hamtic', 'FIRE_HYDRANT', 1, 'Poblacion 2, Hamtic, Antique (in front of Anteaues Bestea)', 10.7011186, 121.9817536, 'Wet Barrel'),
