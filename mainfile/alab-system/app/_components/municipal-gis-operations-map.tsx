...
export function MunicipalGisOperationsMap() {
  const { municipality, incidents, loading, refreshing, error, refresh } = useMunicipalIncidentFeed({ includeHistory: true, autoRefresh: false });
