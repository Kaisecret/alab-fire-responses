...
const styles = `
  ...
  .water-registry__card { display:flex; flex-direction:column; min-height:230px; color:inherit; text-decoration:none; background:#fff; border:1px solid #e4e7ec; border-radius:12px; overflow:hidden; transition:border-color .18s, transform .18s, box-shadow .18s; }
