...
const guideMarkup = `
    <div class="dashboard-page-root">
        ...
        <main style="padding: 4rem 2rem; text-align: center; min-height: 70vh; display: flex; flex-direction: column; align-items: center; justify-content: center;">
            <h1 style="font-size: 2.5rem; color: var(--primary-red); margin-bottom: 1rem;">Fire Guide</h1>
            <p style="color: var(--text-muted); font-size: 1.1rem;">This is a simple placeholder page for the Fire Safety Guide.</p>
        </main>
...
export default function GuidePage() {
  return (
    <div dangerouslySetInnerHTML={{ __html: "<style>" + homeStyles + "</style>" + guideMarkup }} />
  );
}
