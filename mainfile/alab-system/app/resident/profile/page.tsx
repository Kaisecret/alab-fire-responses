    ...
    <div class="dashboard-page-root">
        <header class="top-header">
            ...
            <div class="header-nav">
                ...
                <div class="nav-item-wrapper">
                    <a href="/resident/profile" class="nav-item active">
                        <svg class="nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <main style="padding: 4rem 2rem; text-align: center; min-height: 70vh; display: flex; flex-direction: column; align-items: center; justify-content: center;">
            <h1 style="font-size: 2.5rem; color: var(--primary-red); margin-bottom: 1rem;">My Profile</h1>
            <p style="color: var(--text-muted); font-size: 1.1rem;">This is a simple placeholder page for Profile settings.</p>
        </main>
...
export default function ProfilePage() {
  return (
    <div dangerouslySetInnerHTML={{ __html: "<style>" + homeStyles + "</style>" + profileMarkup }} />
  );
}
