...
export const RESIDENT_TRANSLATIONS = {
  tl: {
    ...
    tacticalRemote: "Mahirap marating na lugar",
    tacticalRemoteSub: "Barado o putol ang daan papunta sa sunog",
    tacticalNarrowStreet: "Makipot na kalsada",
    tacticalNarrowStreetSub: "Mahirap makadaan ang fire truck",
  ...
  hil: {
    ...
    tacticalRemote: "Mabudlay malab-ot nga lugar",
    tacticalRemoteSub: "Nabara ukon wala sing padayon nga dalan",
    tacticalNarrowStreet: "Masiot nga dalan",
    tacticalNarrowStreetSub: "Mabudlay makaagi ang fire truck",
  ...
  en: {
    ...
    tacticalPacked: "Houses are close together",
    tacticalPackedSub: "Flames may spread between nearby houses",
    tacticalAlley: "Narrow alley or interior road",
    tacticalAlleySub: "A fire truck may not fit",
    tacticalRemote: "Difficult road access",
    tacticalRemoteSub: "Road is blocked or ends before the fire",
    tacticalNarrowStreet: "Narrow street",
    tacticalNarrowStreetSub: "Fire trucks may have difficulty passing",
