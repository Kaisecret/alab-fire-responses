...
import { getManagementSummary } from "../../../../lib/provincial-bfp/management/overview";
...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    const summary = await getManagementSummary(actor, filters);
    ...
    const message = error instanceof Error ? error.message : "SUMMARY_QUERY_FAILED";
