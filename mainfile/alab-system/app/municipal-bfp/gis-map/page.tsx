...
import { AntiqueGisMap } from '../../_components/antique-gis-map';
...
const styles = `
  ...
  .mbfp-antique-map-wash { position: absolute; inset: 0; z-index: 1; pointer-events: none; background: linear-gradient(135deg, rgba(211,47,47,0.08), transparent 32%), radial-gradient(circle at 25% 25%, rgba(22,101,192,0.08), transparent 36%), radial-gradient(circle at 78% 72%, rgba(0,131,143,0.1), transparent 34%); mix-blend-mode: multiply; }
  ...
  @media (max-width: 768px) {
    ...
    .mbfp-antique-map-shell { height: 560px; min-height: 560px; }
    .mbfp-antique-map-title { top: 10px; left: 10px; max-width: calc(100% - 84px); }
      ...
      <div className="mbfp-page">
        <div className="mbfp-page-header">
          ...
          <div className="mbfp-gis-controls">
            <button className="mbfp-gis-ctrl active"><i className="fa-solid fa-fire" /> Incidents</button>
            <button className="mbfp-gis-ctrl"><i className="fa-solid fa-house-fire" /> Stations</button>
            <button className="mbfp-gis-ctrl"><i className="fa-solid fa-droplet" /> Water Sources</button>
            <button className="mbfp-gis-ctrl"><i className="fa-solid fa-layer-group" /> All Layers</button>
          </div>
        </div>
